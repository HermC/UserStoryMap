...
public class StoryMapperTest {
    ...
    @Test
    public void findByMapIdAndParentId() {
        List<Story> result1 = storyMapper.findByMapIdAndParentId(2, -1);
    ...
    public void updateTypeStatusNameDesTest() {
        ...
        int result1 = storyMapper.update(story);
        assert result1 == 1;
        Story newStory = storyMapper.findByStoryId(2);
        ...
        assert newStory.getStory_status().equals(Story.StoryStatus.DOING);
        assert newStory.getStory_type().equals(Story.StoryType.STORY);
    }
