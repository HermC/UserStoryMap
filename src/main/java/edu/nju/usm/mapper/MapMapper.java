...
public interface MapMapper {
     ...
     * 新增地图
     * */
    @Insert({"INSERT INTO map(map_name, description, owner_id, created_time) VALUES(#{map_name}, #{description}, #{owner_id}, #{created_time})"})
     ...
     * 删除地图
     * */
    @Delete("DELETE FROM map WHERE map_id = #{map_id}")
